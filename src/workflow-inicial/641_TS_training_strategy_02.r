...
PARAM$final_train <- c(
  ...
  202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 201912,
  201911, 201910, 201909
)

PARAM$train$training <- c(
  202105, 202104, 202103, 202102, 202101,
  202012, 202011, 202010, 202009, 202008, 202007, 202006, 201912, 201911,
...
PARAM$train$semilla <- 888887 # cambiar por su propia semilla  !!!
